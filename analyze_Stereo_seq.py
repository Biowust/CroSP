...
# Mouse_olfactory_bulb,Mouse_embryo

def parse(print_help=False):
    parser = argparse.ArgumentParser(description='Analyze')
    parser.add_argument('--data_type', type=str, default='Stereo_seq', help='Type of data platform (e.g., "10X")')
    parser.add_argument('--task_type', type=str, default='Identify', help='Type of task to perform (e.g., "Identify")')
    parser.add_argument('--data_name', type=str, default='Mouse_olfactory_bulb', help='Name of the section')
    ...
    parser.add_argument('--epoch', type=float, default=200, help='Number of epochs')
...
if __name__ == "__main__":
    ...
    if not args.build_data:
        ...
        build_data.process_Stereo_seq(platform=data_type, save_path=save_path, data_path=data_path,

...
def cluster_and_evaluate_with_seed(adata):
    ...
    ARI = metrics.adjusted_rand_score(adata.obs['mclust'], adata.obs['label'])
...
def parse(print_help=False):
    ...
    parser.add_argument('--data_type', type=str, default='STARmap', help='Type of data platform (e.g., "10X")')
    parser.add_argument('--task_type', type=str, default='Identify', help='Type of task to perform (e.g., "Identify")')
    parser.add_argument('--data_name', type=str, default='Mouse_visual_cortex', help='Name of the section')
    parser.add_argument('--n_spa', type=int, default='1000', help='Spatial feature input dimension')
    parser.add_argument('--n_img', type=int, default='1000', help='Image feature input dimension')
    ...
    parser.add_argument('--emb_dim', nargs='+', default=[512, 256, 256, 256, 32])
    parser.add_argument('--epoch', type=float, default=250, help='Number of epochs')
    ...
    parser.add_argument('--lambda2', type=float, default=1.0, help='parameter for Reconstruction_Loss')
    parser.add_argument('--lambda3', type=float, default=8.0, help='parameter for Metric Loss')
...
if __name__ == "__main__":
    ...
    if not args.build_data:
        ...
        build_data.process_STARmap(platform=data_type, save_path=save_path, data_path=data_path,
